let buttonGirasol = document.querySelector('#Girasol')
...
let buttonTulipanes = document.querySelector('#Tulipanes')
...
let buttonDienteLeon = document.querySelector('#DienteLeon')
